...
public:
	void GetScreenSize(int &width_out, int &height_out)
	{
		...
		return pVirtualFunc.GetVFunc<FN>(this, 5)(this, width_out, height_out);
	}

	void ServerCmd(const char *szCmdString, bool bReliable)
	{
		typedef void(__thiscall *FN)(void*, const char *, bool);
		return pVirtualFunc.GetVFunc<FN>(this, 6)(this, szCmdString, bReliable);
	}

	bool GetPlayerInfo(int nEntityIndex, PlayerInfo_t *pPlayerInfo)
	{
		typedef bool(__thiscall *FN)(void*, int, PlayerInfo_t *);
		return pVirtualFunc.GetVFunc<FN>(this, 8)(this, nEntityIndex, pPlayerInfo);
	}

	int GetPlayerForUserID(int userID)
	{
		typedef bool(__thiscall* FN)(void*, int);
		return pVirtualFunc.GetVFunc<FN>(this, 9)(this, userID);
	}

	bool Con_IsVisible()
	{
		typedef bool(__thiscall *FN)(void*);
		return pVirtualFunc.GetVFunc<FN>(this, 11)(this);
	}

	int GetLocalPlayer()
	{
		typedef int(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 12)(this);
	}

	float Time()
	{
		typedef float(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 14)(this);
	}

	void GetViewAngles(Vec3 &va)
	{
		typedef void(__thiscall *FN)(PVOID, Vec3 &va);
		return pVirtualFunc.GetVFunc<FN>(this, 19)(this, va);
	}
	...
	{
		typedef void(__thiscall *FN)(PVOID, Vec3 &va);
		return pVirtualFunc.GetVFunc<FN>(this, 20)(this, va);
	}

	int GetMaxClients()
	{
		typedef int(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 21)(this);
	}

	bool IsInGame()
	{
		typedef bool(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 26)(this);
	}

	bool IsConnected()
	{
		typedef bool(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 27)(this);
	}

	bool IsDrawingLoadingImage()
	{
		typedef bool(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 28)(this);
	}

	const matrix3x4 &WorldToScreenMatrix()
	{
		typedef const matrix3x4 &(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 36)(this);
	}

	void FireEvents()
	{
		typedef void(__thiscall* FN)(PVOID);
		pVirtualFunc.GetVFunc<FN>(this, 56)(this);
	...
	{
		typedef bool(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 85)(this);
	}

	bool IsHLTV()
	{
		typedef bool(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 86)(this);
	}

	bool IsPlayingTimeDemo()
	{
		typedef bool(__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 78)(this);
	}

	bool IsActiveApp()
	{
		typedef bool(__thiscall* FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 142)(this);
	}

	CNetChannel* GetNetChannelInfo()
	{
		typedef CNetChannel* (__thiscall *FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 72)(this);
	}

	void ClientCmd_Unrestricted(const char *szCommandString)
	{
		typedef void(__thiscall *FN)(PVOID, const char *);
		return pVirtualFunc.GetVFunc<FN>(this, 106)(this, szCommandString);
	}

	void ServerCmdKeyValues(KeyValues* pKV)
	{
		typedef void(__thiscall* FN)(void*, KeyValues*);
		pVirtualFunc.GetVFunc<FN>(this, 127)(this, pKV);
	...
	ISpatialQuery *GetBSPTreeQuery()
	{
		...
		return pVirtualFunc.GetVFunc<FN>(this, 42)(this);
	}

	char const* GetLevelName()
	{
		typedef char const* (__thiscall* FN)(PVOID);
		return pVirtualFunc.GetVFunc<FN>(this, 51)(this);
	}
};
